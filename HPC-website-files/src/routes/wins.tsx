...
export const Route = createFileRoute('/wins')({
  head: () => ({
    meta: [
      { title: 'Member Wins — HPC' },
      { name: 'description', content: 'Google reviews and campaign milestones from members of the Capital Campaign Accelerator, shared with their permission.' },
      { property: 'og:title', content: 'Member Wins — HPC' },
      { property: 'og:description', content: 'Google reviews and campaign milestones from members of the Capital Campaign Accelerator, shared with their permission.' },
    ],
  }),
  component: WinsPage,
});
