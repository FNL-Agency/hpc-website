...
export const Route = createFileRoute('/campaigns')({
  head: () => ({
    meta: [
      { title: 'The Capital Campaign Accelerator — HPC' },
      { name: 'description', content: 'A capital campaign system for organizations that do not have a campaign team. Assessment, 90-day plan, weekly coaching, and a 90-day money-back guarantee.' },
      { property: 'og:title', content: 'The Capital Campaign Accelerator — HPC' },
      { property: 'og:description', content: 'A capital campaign system for organizations that do not have a campaign team. Assessment, 90-day plan, weekly coaching, and a 90-day money-back guarantee.' },
    ],
  }),
