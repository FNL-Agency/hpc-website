...
export const Route = createFileRoute('/resources')({
  head: () => ({
    meta: [
      { title: 'Resources — HPC' },
      { name: 'description', content: 'Free tools, plain-English guides and a monthly capital campaigns webinar for nonprofit leaders.' },
      { property: 'og:title', content: 'Resources — HPC' },
      { property: 'og:description', content: 'Free tools, plain-English guides and a monthly capital campaigns webinar for nonprofit leaders.' },
    ],
  }),
        ...
        <section className="tools-section">
          <div className="container">
            ...
            <div className="tools-grid">
              ...
              <a href="/#calculator" className="tool-card">
                <div className="tool-card-icon">
                  <svg viewBox="0 0 40 40" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
