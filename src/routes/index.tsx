...
export const Route = createFileRoute('/')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'The Capital Campaign Accelerator: coaching, system and community for nonprofits running $1M–$5M campaigns — without a six-figure feasibility study to start.' },
      { property: 'og:title', content: 'HPC — Capital campaigns, designed for the small nonprofit' },
      { property: 'og:description', content: 'The Capital Campaign Accelerator: coaching, system and community for nonprofits running $1M–$5M campaigns — without a six-figure feasibility study to start.' },
    ],
  }),
  component: HomePage,
});
