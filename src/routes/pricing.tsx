...
export const Route = createFileRoute('/pricing')({
  head: () => ({
    meta: [
      { title: 'Pricing — HPC' },
      { name: 'description', content: 'Published, flat-rate pricing for capital campaign coaching. Starts at $2,500/month with a 90-day money-back guarantee. No hourly billing, no six-figure retainers.' },
      { property: 'og:title', content: 'Pricing — HPC' },
      { property: 'og:description', content: 'Published, flat-rate pricing for capital campaign coaching. Starts at $2,500/month with a 90-day money-back guarantee. No hourly billing, no six-figure retainers.' },
    ],
  }),
