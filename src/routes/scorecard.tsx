...
export const Route = createFileRoute('/scorecard')({
  head: () => ({
    meta: [
      { title: 'Capital Campaign Readiness Scorecard — HPC' },
      { name: 'description', content: 'Twelve honest questions and a real readiness score. Find out whether your organization is ready to launch a capital campaign — and what to fix first.' },
      { property: 'og:title', content: 'Capital Campaign Readiness Scorecard — HPC' },
      { property: 'og:description', content: 'Twelve honest questions and a real readiness score. Find out whether your organization is ready to launch a capital campaign — and what to fix first.' },
    ],
  }),
